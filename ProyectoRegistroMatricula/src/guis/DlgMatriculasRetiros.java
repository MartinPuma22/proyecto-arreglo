...
public class DlgMatriculasRetiros extends JDialog {
    ...
    public DlgMatriculasRetiros() {
        ...
        JLabel lblCodigoMatricula = new JLabel("Código de Matrícula:");
        ...
        // Etiqueta y campo de texto para código de retiro
        JLabel lblCodigoRetiro = new JLabel("Código de Retiro:");
