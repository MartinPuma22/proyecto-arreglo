...
public class Principal extends JFrame implements ActionListener {
	...
	public Principal() {
		...
		mntmAlumnosMatriculados.addActionListener(this);
	...
	if(e.getSource() == mntmMatricula)
		...
		{	actionPerformedrntmMatriculasRetiros(e);		}		
	...
	{	int result = JOptionPane.showConfirmDialog(null,"¿Quieres salir de la aplicación?","Salir", JOptionPane.YES_NO_OPTION);
	...
	{	DlgAlumnosCursos dac=new DlgAlumnosCursos();
		dac.setLocationRelativeTo(this);
		dac.setModal(true);
		dac.setVisible(true);
	}
	
	protected void actionPerformedrntmMatriculasRetiros(ActionEvent e) 
	{	DlgMatriculasRetiros dmr=new DlgMatriculasRetiros();
		dmr.setLocationRelativeTo(this);
		dmr.setModal(true);
		dmr.setVisible(true);
	}
	
	protected void actionPerformedrntmMatriculaPendiente(ActionEvent e) 
	...
	protected void actionPerformedrntmMatriculaVigente(ActionEvent e) 
	...
	protected void actionPerformedrntmAlumnosMatriculados(ActionEvent e) 
	{	DlgAlumnosMatriculados dam=new DlgAlumnosMatriculados();
