...
{	private JLabel lblNumRetiro;
    ...
    public DlgRetiro() {
        ...
        lblNumRetiro = new JLabel("Nº Retiro");
		lblNumRetiro.setBounds(21, 11, 50, 23);
		getContentPane().add(lblNumRetiro);
		
		lblNumMatricula = new JLabel("Nº Matrícula");
...
//  Declaración global
	...
	{	TableColumnModel tcm = tblMatricula.getColumnModel();
		...
		tcm.getColumn(1).setPreferredWidth(anchoColumna(30));  // numMatrícula
